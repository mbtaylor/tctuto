...
\begin{minipage}[t]{11cm}
  ...
  \begin{itemize}
    ...
    \item You can also investigate outliers using the
          \mb{activate_butt}{Views}{Activation Actions} window.
          Try the \lab{Display HiPS cutout} option or,
          if you have Aladin desktop running,
          \lab{Send Sky Coordinates}.
