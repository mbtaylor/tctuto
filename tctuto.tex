...
\newcommand{\winfig}[2]
           {\vspace*{-0.5cm}
            \hspace*{0.5cm}\mbox{\vtop{\hbox{\includegraphics[#1]{#2}}}}}
...
% \item Start up Aladin with all-sky mode and use SAMP to see image data
%       for some of the matched objects.
  \end{itemize}
% \begin{center}
% \includegraphics[width=0.8\textwidth]{n3_samp.png}
% \end{center}
\end{minipage}
\begin{minipage}[t]{8cm}
